...
- (NSDictionary *)toMap {
  return @{
    ...
    @"allowMultipleVerifiedDevice" : (self.allowMultipleVerifiedDevice ?: [NSNull null]),
  };
}
@end
...
void FLTServerApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FLTServerApi> *api) {
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.ServerApi.startServer"
    ...
    if (api) {
      ...
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        ...
        FLTConfig *arg_config = GetNullableObjectAtIndex(args, 0);
...
void FLTClientApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FLTClientApi> *api) {
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.ClientApi.startClient"
        binaryMessenger:binaryMessenger
...
void FLTConnectionApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FLTConnectionApi> *api) {
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.ConnectionApi.connect"
        binaryMessenger:binaryMessenger
    ...
    if (api) {
      ...
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        NSString *arg_toDeviceId = GetNullableObjectAtIndex(args, 0);
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.ConnectionApi.disconnect"
        binaryMessenger:binaryMessenger
        codec:FLTConnectionApiGetCodec()        ];
    if (api) {
...
void FLTDeviceVerificationApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FLTDeviceVerificationApi> *api) {
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.DeviceVerificationApi.requestDeviceVerification"
        binaryMessenger:binaryMessenger
    ...
    if (api) {
      ...
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        NSString *arg_toDeviceId = GetNullableObjectAtIndex(args, 0);
        FLTDeviceVerificationRequest *arg_request = GetNullableObjectAtIndex(args, 1);
...
- (void)onDeviceVerifiedDevice:(FLTConnectedDevice *)arg_device request:(FLTDeviceVerificationRequest *)arg_request completion:(void(^)(NSError *_Nullable))completion {
  ...
  [channel sendMessage:@[arg_device ?: [NSNull null], arg_request ?: [NSNull null]] reply:^(id reply) {
    completion(nil);
  }];
}
@end
...
- (void)onDeviceDiscoveredDeviceId:(NSString *)arg_deviceId deviceName:(NSString *)arg_deviceName completion:(void(^)(NSError *_Nullable))completion {
  ...
  [channel sendMessage:@[arg_deviceId ?: [NSNull null], arg_deviceName ?: [NSNull null]] reply:^(id reply) {
    completion(nil);
  }];
}
- (void)onDeviceLostDeviceId:(NSString *)arg_deviceId completion:(void(^)(NSError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      ...
      binaryMessenger:self.binaryMessenger
      codec:FLTDiscoveryCallbackApiGetCodec()];
  [channel sendMessage:@[arg_deviceId ?: [NSNull null]] reply:^(id reply) {
    completion(nil);
  }];
}
@end
...
void FLTAdvertiseApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FLTAdvertiseApi> *api) {
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.AdvertiseApi.startAdvertise"
        binaryMessenger:binaryMessenger
    ...
    if (api) {
      ...
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        NSString *arg_verificationCode = GetNullableObjectAtIndex(args, 0);
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.AdvertiseApi.stopAdvertise"
        binaryMessenger:binaryMessenger
        codec:FLTAdvertiseApiGetCodec()        ];
    if (api) {
...
void FLTCommunicationApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FLTCommunicationApi> *api) {
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.CommunicationApi.sendMessage"
        binaryMessenger:binaryMessenger
    ...
    if (api) {
      ...
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        ...
        NSString *arg_payload = GetNullableObjectAtIndex(args, 2);
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.CommunicationApi.sendMessageToVerifiedDevice"
        binaryMessenger:binaryMessenger
        codec:FLTCommunicationApiGetCodec()        ];
    if (api) {
      ...
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        NSString *arg_endpoint = GetNullableObjectAtIndex(args, 0);
        NSString *arg_data = GetNullableObjectAtIndex(args, 1);
...
- (void)onRawMessageReceivedDeviceId:(NSString *)arg_deviceId msg:(NSString *)arg_msg completion:(void(^)(NSError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      ...
      binaryMessenger:self.binaryMessenger
      codec:FLTCommunicationCallbackApiGetCodec()];
  [channel sendMessage:@[arg_deviceId ?: [NSNull null], arg_msg ?: [NSNull null]] reply:^(id reply) {
    completion(nil);
  }];
}
@end
...
- (void)onBluetoothStateChangedState:(FLTStateResponse *)arg_state completion:(void(^)(NSError *_Nullable))completion {
  ...
  [channel sendMessage:@[arg_state ?: [NSNull null]] reply:^(id reply) {
    completion(nil);
  }];
}
