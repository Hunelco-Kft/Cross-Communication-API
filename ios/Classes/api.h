...
- (void)connectToDeviceId:(NSString *)toDeviceId displayName:(NSString *)displayName completion:(void(^)(FLTConnectedDevice *_Nullable, FlutterError *_Nullable))completion;
- (void)disconnectId:(NSString *)id completion:(void(^)(NSNumber *_Nullable, FlutterError *_Nullable))completion;
@end
...
- (void)requestDeviceVerificationToDeviceId:(NSString *)toDeviceId request:(FLTDeviceVerificationRequest *)request completion:(void(^)(NSDictionary<NSString *, NSString *> *_Nullable, FlutterError *_Nullable))completion;
@end
...
- (void)sendMessageToDeviceId:(NSString *)toDeviceId endpoint:(NSString *)endpoint payload:(NSString *)payload completion:(void(^)(NSNumber *_Nullable, FlutterError *_Nullable))completion;
- (void)sendMessageToVerifiedDeviceEndpoint:(NSString *)endpoint data:(NSString *)data completion:(void(^)(NSNumber *_Nullable, FlutterError *_Nullable))completion;
@end
